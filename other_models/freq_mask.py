...
class FreqMask(torch.nn.Module):
    def __init__(self, 
        ...
        freq_map = torch.unsqueeze(freq_map, 0)
        freq_map = torch.unsqueeze(freq_map, 2)
        self.mask = torch.nn.Parameter(torch.randn(freq_map.size()))
...
if __name__ == '__main__':
    ...
    print("Training Freq Mask for " + str(args.training_epoch) + " epochs")

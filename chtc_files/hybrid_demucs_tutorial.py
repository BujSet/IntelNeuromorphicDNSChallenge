...
def output_results(original_source: torch.Tensor, predicted_source: torch.Tensor, source: str):
    ...
    plot_spectrogram(stft(predicted_source)[0], f"Spectrogram - {source}", f"spectogram_{source}")
...
# Mixture Clip
plot_spectrogram(stft(mix_spec)[0], "Spectrogram - Mixture", "spectogram_Mixture")

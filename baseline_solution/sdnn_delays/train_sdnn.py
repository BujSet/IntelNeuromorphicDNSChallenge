...
#        print(meta.get_device())
#        print(type(clean))
#        print(type(noise))
#        print(type(meta))
#        print(meta[2])
        ssl_noisy = torch.zeros(batchSize, 480000)
        self._segmental_snr_mixer(clean[0,:], noise[0,:], snr, 
                targetLevel,
                targetLevelLower,
                targetLevelHigher)
